    ...
    return <>
        <div className="mx-8 sm:mx-16 xl:mx-24 relative"> 
            <div className="text-center mt-20 mb-8">
                ...
                <img src={assets.assets.star_icon} alt="" className="w-2.5"/>
            </div>
            ...
            <p className="my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500">This is your space to think out loud, to share what matters, and o write without filters. Whether it's one word or a thousands, your atory starts right here.</p>
            ...
            <img src={assets.assets.gradientBackground} alt="" className="absolute -top-50 -z-1 opacity-50"/>
        </div>
